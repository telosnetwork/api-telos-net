...
async function exclude(stats, exclusions, contract = '', symbol){
    ...
    for (let i = 0; i < exclusions.length; i++) {
        ...
        let balanceString = await getCurrencyBalance(accountToCheck, contract, symbol ? symbol.toUpperCase() : symbol);
